...
public class Controller {
    ...
    public void clickCheckButton(ActionEvent actionEvent) {
        ...
        String text = String.format("%d. Введено число %s, количество быков %s, количество коров %d", ++step, answer, count.getBulls(), count.getCows());
    ...
    private boolean ifWantToPlayAgain() {
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION, "Поздравляю, Вы выйграли!\n" +
